...
void setup() {
  ...
  File file = SD.open("/newdata.txt");
  if (!file) {
    Serial.println("File doesn't exist");
    Serial.println("Creating file...");
    writeFile(SD, "/newdata.txt", "Date || Time; Temp; Pressure; CO2; PM0.3; PM0.5; PM1.0; PM2.5; PM5.0; PM10; Motion \r\n");
  } else {
...
void loop() {
  ...
  dataMessage = String(now.day()) + String("/") + String(now.month()) + String("/") + String(now.year()) + String("||") +
                ...
                String(";") + pm03 + String(";") + pm05 + String(";") + pm01 + String(";") + pm25 + String(";") + pm50 + String(";") + pm10 + 
                String(";") + detect + "\r\n";
  ...
  appendFile(SD, "/newdata.txt", dataMessage.c_str());
